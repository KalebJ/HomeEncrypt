...
class EncryptionWorkspace extends JPanel { //This is the primary class for displaying the GUI and calling Encryption commands
   ...
   final private JTextField PIN = new JTextField(9);
   ...
   private File plainTextArchive, exitButtonImage;
   ...
   private String userPINText = "1234";
   ...
   @SuppressWarnings({ "unchecked", "rawtypes" })
      EncryptionWorkspace() {
         ...
         userPIN.add(new JLabel("<HTML><font color = '#BBFAF7'>PIN Number: </font></html>")); //HTML can be used in strings, had trouble using tags that were divided: "<tag>" + var + "</tag>"
         userPIN.add(PIN);
         ...
         encryptionPanel.setPreferredSize(new Dimension(250,170));
         ...
         if (exitButtonImage.exists() && !exitButtonImage.isHidden()){
            ...
            System.out.println(exitButtonImage.getAbsolutePath().toString());
   ...
   private void checkLoginInfo() {
      ...
      if (userPINText.matches("^[0-9]{1,4}$")) { //Regex: string contains only chars 0-9 and is 1 to 4 chars long
         userInfo.setForeground(new Color(247, 233, 8)); //Same color as #BBFAF7, converted on the Internet to RGB
         userInfo.setText(userKeyWord + " " + userPINText);
         remove(openingPanel);
         add(encryptionPanel);
         ...
         password.setUserPIN(Integer.parseInt(userPINText));
      } else {
